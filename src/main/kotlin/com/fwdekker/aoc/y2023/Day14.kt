...
fun main() {
    ...
    // Part 1
    println("Part one: ${lines.rotateCCW().rollWest().rotateCW().calcLoad()}")
...
private fun List<String>.flipLR(): List<String> = map { it.reversed() }

private fun List<String>.flipUD(): List<String> = reversed()

private fun List<String>.rotateCW(): List<String> = transpose().flipLR()

private fun List<String>.rotateCCW(): List<String> = transpose().flipUD()


private fun List<String>.rollWest(): List<String> =
...
private fun List<String>.cycle(repetitions: Int = 1): List<String> {
    ...
    for (repetition in 1..repetitions) {
        platform = (1..4).fold(platform) { it, _ -> it.rollWest().rotateCW() }
